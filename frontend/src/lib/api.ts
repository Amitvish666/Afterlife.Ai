...
export const apiClient = {
  ...
  generateAvatar: (personaId: string, data: { style: string; size?: string; prompt?: string }) =>
    api.post<ApiResponse<unknown>>(`/v1/avatars/${personaId}/avatars/generate`, data),
  
  listAvatars: (personaId: string) =>
    api.get<ApiResponse<unknown[]>>(`/v1/avatars/${personaId}/avatars`),
