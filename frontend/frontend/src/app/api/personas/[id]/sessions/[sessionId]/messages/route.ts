...
import { getSessionById, getPersonaById, getMemoriesForPersona, updateSession } from '../../../../../auth/db';
...
export async function POST(
  ...
  try {
    ...
    await updateSession(sessionId, { message_count: (session.message_count || 0) + 1 });
