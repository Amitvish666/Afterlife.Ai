...
class ChatEngine:
    ...
    async def chat(
        ...
        try:
            ...
            # Generate response - use Ollama or OpenAI based on settings
            if self.use_ollama:
                ...
                tokens_used = response.usage if response.usage else 0
            else:
                # Use OpenAI
    ...
    async def stream_chat(
        ...
        try:
            ...
            # Get streaming response - use Ollama or OpenAI based on settings
            if self.use_ollama:
